...
class BaseTrainer(ABC):
    ...
    def train(self, dataset: BaseADDataset, net: BaseNet) -> BaseNet:
        """
        Implement train method that trains the given networks using the train_set of datasets.
        :return: Trained net
        """
        pass
    ...
    def test(self, dataset: BaseADDataset, net: BaseNet):
        """
        Implement test method that evaluates the test_set of datasets on the given networks.
        """
        pass
